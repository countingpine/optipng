...
test\print_ratio_test.exe: \
  test\print_ratio_test.c test\sprint_ratio.generated.c test\print_ratio.h
	$(CC) $(CPPFLAGS) $(CFLAGS) -out:$@ test\print_ratio_test.c test\sprint_ratio.generated.c
...
install: optipng.exe
	...
	cp -f -p optipng.exe optipng.exe.manifest $(DESTDIR)$(bindir)
